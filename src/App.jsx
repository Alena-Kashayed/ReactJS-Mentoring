      ...
      assets: [
        {
          ...
          show_cast:
            'Uma Thurman, David Carradine, Michael Madsen, Daryl Hannah, Gordon Liu, Michael Parks, Perla Haney-Jardine, Helen Kim, Claire Smithies, Clark Middleton',
        ...
        },
        {
          ...
          show_cast:
            'John Travolta, Samuel L. Jackson, Uma Thurman, Bruce Willis, Harvey Keitel, Tim Roth, Amanda Plummer, Ving Rhames, Eric Stoltz, Maria de Medeiros',
          director: 'Quentin Tarantino',
          summary:
        ...
        },
        {
          ...
          category: 'Dramas',
          show_cast:
            "Pam Grier, Samuel L. Jackson, Robert Forster, Bridget Fonda, Michael Keaton, Robert De Niro, Michael Bowen, Chris Tucker, Lisa Gay Hamilton, Tommy 'Tiny' Lister",
          director: 'Quentin Tarantino',
          summary:
        ...
        },
        {
          ...
          show_cast:
            'Harvey Keitel, Tim Roth, Michael Madsen, Steve Buscemi, Chris Penn, Lawrence Tierney, Edward Bunker, Quentin Tarantino, Randy Brooks, Kirk Baltz',
          director: 'Quentin Tarantino',
          summary:
        ...
        },
        {
          ...
          category: 'Comedies',
          show_cast:
            'Tim Roth, Antonio Banderas, Jennifer Beals, Bruce Willis, Paul Calderon, Madonna, Marisa Tomei, Quentin Tarantino, Ione Skye, Lili Taylor',
          director:
      ...
      <div className={styles.app}>
        <div className={styles.headerBlock}>
          {this.state.showSearch ? (
            <Search movieNumber={this.state.assets.length} />
          ) : (
            <Details
